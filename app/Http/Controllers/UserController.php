    ...
    public function store(Request $request)
    {
        ...
        if ($request->roles == "dosen") {
            ...
            if ($countDosen >= 1) {
                ...
                return redirect()->route('user.index')->with('error', 'NIDN tidak terdaftar sebagai dosen');
            }
            ...
            if ($countKaprodi >= 1) {
                ...
                return redirect()->route('user.index')->with('error', 'NIDN tidak terdaftar sebagai kaprodi');
            }
            ...
            if ($countMahasiswa >= 1) {
                ...
                return redirect()->route('user.index')->with('error', 'NOBP tidak terdaftar sebagai mahasiswa');
            }
        } else {
            User::create([
                'name' => $request->name,
