        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-header">Master Data</li>
                    ...
                    <li class="{{ request()->routeIs('dosen.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('dosen.index') }}"><i class="fas fa-user"></i><span>Dosen</span></a>
                    </li>
                    <li class="{{ request()->routeIs('mahasiswa.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('mahasiswa.index') }}"><i class="fas fa-user"></i><span>Mahasiswa</span></a>
                    </li>
                    <li class="{{ request()->routeIs('kaprodi.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('kaprodi.index') }}"> <i class="fas fa-user"></i><span>Kaprodi</span></a>
                    </li>
