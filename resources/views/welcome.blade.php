...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="nav-item">
            <a class="nav-link scrollto" href="{{ asset('data_file/panduan.pdf') }}" download>Panduan Pengguna</a>
          </li>
    ...
    <div class="logo me-auto">
        ...
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="index.html"><img src="assets/landing/img/ti.png" alt="" class="img-fluid"></a>
        <a href="index.html"><img src="assets/landing/img/pnp.jpeg" alt="" class="img-fluid"></a>
      </div>
  </header><!-- End Header -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/landing/img/team/abdi.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/landing/img/team/alfa.jpg" alt="">
              <h4>Alfa Ramadhan</h4>
              <span>Front-End</span>
              <p>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/landing/img/team/aura.jpg" alt="">
              <h4>Aura Zulaikha</h4>
              <span>Back-End</span>
              <p>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/landing/img/team/rayhan.png" alt="">
